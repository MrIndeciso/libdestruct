...
class BasicTest(unittest.TestCase):
    def test_basic_types(self):
        ...
        self.assertEqual(provola1.value(), twos_complement(0xdeadbeef, 32))
        self.assertEqual(provola2.value(), (0xdeadbeef * 2) & ((1 << 32) - 1))
        self.assertEqual(provola3.value(), twos_complement(0xdeadbeefdeadbeef, 64))
        self.assertEqual(provola4.value(), (0xdeadbeefdeadbeef * 2) & ((1 << 64) - 1))
